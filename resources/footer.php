        ...
        <!-- /.row -->
   		...
   		<!-- THE HEPPELL FOOTER -->
	<div class="cls-global-footer cls-global-footer-sponsors hidden-print">
    <div class="container">
	...
	<div class="cls-global-footer cls-global-footer-inverse cls-global-footer-body hidden-print">
	<div class="container">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <ul class="list-unstyled cls-global-footer-link-spacer">
                        ...
                        <li><a title="About" target="_self" href="https://www.chesterlestreetasc.co.uk/about">About</a></li>
            ...
            <div class="row">
                ...
                <ul class="list-unstyled cls-global-footer-link-spacer">
                 ...
                 <ul class="list-unstyled cls-global-footer-link-spacer">  
                    ...
                    <li><i class="fa fa-twitter fa-fw" aria-hidden="true"></i> <a title="Twitter" target="_blank" href="https://twitter.com/CLSASC1">Twitter</a></li>
                    <li><i class="fa fa-facebook fa-fw" aria-hidden="true"></i> <a title="Facebook" target="_blank" href="https://www.facebook.com/Chester-le-Street-ASC-349933305154137/">Facebook</a></li>
                    <li><i class="fa fa-google-plus fa-fw" aria-hidden="true"></i> <a title="Google Plus" target="_blank" href="https://plus.google.com/&#43;ChesterLeStreetASCUK">Google Plus</a></li>
                </ul>
                </div>
                ...
                <p><!-- https://www.google.co.uk/accounts/AccountChooser?prompt=select_account&continue=https://apps.google.com/user/hub -->
                <!--https://www.google.co.uk/accounts/AccountChooser?prompt=select_account&continue=https%3A%2F%2Faccounts.google.co.uk%2Fo%2Fsaml2%2Finitsso%3Fidpid%3DC02hzmemx%26spid%3D1093653629497%26forceauthn%3Dfalse-->
                
            <!-- <!--https://www.google.co.uk/accounts/AccountChooser?prompt=select_account&continue=https%3A%2F%2Faccounts.google.co.uk%2Fo%2Fsaml2%2Finitsso%3Fidpid%3DC02hzmemx%26spid%3D1093653629497%26forceauthn%3Dfalse-->
                <strong>Committee Services</strong><br><a title="Login to G Suite" target="_blank" href="http://login.chesterlestreetasc.co.uk/">G Suite Login</a>
                </p>
    ...
    <div class="row">
        <div class="col-xs-12 source-org vcard copyright">
        	<hr>
			<p class="hidden-print">Designed and Built by Chester&#8209;le&#8209;Street ASC</p>
            <p class="m-b-0" style="margin-bottom:0">&copy; <?php echo date( 'Y' ); ?> <span class="org fn">Chester&#8209;le&#8209;Street ASC</span>. CLS ASC is not responsible for the content of external sites.</p>
        </div>
	</div>
        ...
        <style>#cookie-law{background:#333;color:#FFF;margin:-20px 0 20px 0;padding:10px 0 10px 0}#cookie-law .alert-link{text-decoration:underline}.cls-global-footer-link-spacer li{padding-bottom:3px}</style>
        
        <script src="/resources/js/jquery.min.js"></script>
        <script src="https://static.chesterlestreetasc.co.uk/global/js/clscookies.js"></script>
        <!--[if lt IE 9]>
          <script async src="/resources/js/jqueryforltIE9.min.js"></script>
        <![endif]-->
        <script async src="/resources/js/bootstrap.min.js"></script>
  </body>
</html>